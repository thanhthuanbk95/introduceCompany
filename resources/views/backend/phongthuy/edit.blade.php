...
<div class="content-wrapper">
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    <form method="POST" action="{{ route('phongthuy.update', $phongthuy->id) }}" accept-charset="UTF-8" id="phongthuy" class="phongthuyForm" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <input type="hidden" name="_method" value="PUT">
                        <div class="form-group">
                            <div class="col-sm-12">
                                <label for="title">ID:</label>
                                <input class="form-control" name="id" type="text" id="id" value="{{ $phongthuy->id}}" readonly="readonly">
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                @else
                                    <img src="{{URL::asset('/storage/phongthuy/'.$phongthuy->feature_image)}}" height="200px">
