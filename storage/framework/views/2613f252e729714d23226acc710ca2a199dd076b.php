    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <?php endif; ?>
                <div class="row">
                    <form method="POST" action="<?php echo e(route('putEdit')); ?>" accept-charset="UTF-8" id="user_update" class="userForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input class="form-control" name="email" type="email" id="email" value="<?php echo e($user->email); ?>"  disabled="disabled">
                            </div>
