                    ...
                    <form method="POST" action="<?php echo e(route('categories.update',$category->id)); ?>" accept-charset="UTF-8" id="room">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                ...
                                <button class="btn btn-default" type="button" onclick="window.location='<?php echo e(route('categories.index')); ?>';" style="margin-left: 5px;"><i class="glyphicon glyphicon-remove"></i> Trở về</button>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </form>
