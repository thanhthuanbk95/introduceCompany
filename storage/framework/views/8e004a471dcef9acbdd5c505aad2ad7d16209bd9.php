    ...
    <div class="register-box-body">
        ...
        <form method="post" action="<?php echo e(url('/register')); ?>">
            ...
            <div class="form-group has-feedback<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" placeholder="Username">
            ...
            <div class="form-group has-feedback<?php echo e($errors->has('fullname') ? ' has-error' : ''); ?>">
                <input type="text" class="form-control" name="fullname" value="<?php echo e(old('fullname')); ?>" placeholder="Full Name">
                <span class="glyphicon glyphicon-user form-control-feedback"></span>
